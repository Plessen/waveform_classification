...
label_list = {'\sigma_g = 0.03','\sigma_g = 0.04', '\sigma_g = 0.05', '\sigma_g = 0.06', '\sigma_g = 0.07', '\sigma_g = 0.08', 'kaiser in [7]', 'CWD', 'STFT \sigma_g = 0.04'};

plot_overall_test_accuracy(df_list, number_waveforms, SNR, label_list, [0.78 0.84]);
