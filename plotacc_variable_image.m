...
df = get_dataframe('logs_cluster_v4', 'realcnn-attention-bilinear-SST-sigma-0.05-all-waveforms-correct-costas-big-snr', 'version_0');
df1 = get_dataframe('logs_cluster_v4', 'realcnn-attention-bilinear-SST-sigma-0.05-all-waveforms-correct-costas-big-snr-32-32', 'version_0');
df2 = get_dataframe('logs_cluster_v4', 'realcnn-attention-bilinear-SST-sigma-0.05-all-waveforms-correct-costas-big-snr-64-64', 'version_0');
df3 = get_dataframe('logs_cluster_v4', 'realcnn-attention-bilinear-SST-sigma-0.05-all-waveforms-correct-costas-big-snr-128-32', 'version_0');
df4 = get_dataframe('logs_cluster_v4', 'realcnn-attention-bilinear-SST-sigma-0.05-all-waveforms-correct-costas-big-snr-128-64', 'version_0');
df5 = get_dataframe('logs_cluster_v4', 'realcnn-attention-bilinear-SST-sigma-0.05-all-waveforms-correct-costas-big-snr-128-256', 'version_0');
df6 = get_dataframe('logs_cluster_v4', 'realcnn-attention-bilinear-SST-sigma-0.05-all-waveforms-correct-costas-big-snr-256-128', 'version_0');
%df7 = get_dataframe('logs_cluster_v4', 'realcnn-attention-bilinear-SST-sigma-0.05-all-waveforms-correct-costas-big-snr-256-256', 'version_0');

df_list = {df, df1, df2, df3, df4, df5, df6}; %, df7};
number_waveforms = 12;
SNR = -14:2:20;
waveform_list = {'LFM', 'Costas', 'Barker', 'Frank', 'P1', 'P2', 'P3', 'P4', 'T1', 'T2', 'T3', 'T4'};
label_list = {'128x128','32x32', '64x64', '128x32', '128x64', '128x256', '256x128','256x256'};
