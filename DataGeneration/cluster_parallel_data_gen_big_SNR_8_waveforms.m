function [] = cluster_parallel_data_gen_big_SNR_8_waveforms(signals_per_SNR, resize_method, transform, seed, train, sigma)
    ...
    for snr_index = 1:length(SNR)
         prefix_clean = fullfile(output_dir, [prefix resize_method '_' transform '_' num2str(snr_index) '_' 'sigma' '_' num2str(sigma) '_big_snr_8_waveforms.h5']);
...
function combine_h5_files(resize_method, transform, train, snr_length, signals_per_SNR, num_waveforms, image_size, output_dir, sigma)
    ...
    combined_clean_file = fullfile(output_dir, [prefix resize_method '_' transform '_' 'sigma' '_' num2str(sigma) '_big_snr_8_waveforms.h5']);
