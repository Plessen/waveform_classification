function resized_images = transform_data_fading_flat(signal, SNR, N, image_size, resize_method, transform, sigma,... 
    numPaths_range, pathDelay_range, pathGain_range, Kfactor_range, fs, strategy, number_antennas, fc)

    
    output = fading_strategy_flat(signal, SNR, strategy, number_antennas, numPaths_range, pathDelay_range, pathGain_range, Kfactor_range, fs, fc);
