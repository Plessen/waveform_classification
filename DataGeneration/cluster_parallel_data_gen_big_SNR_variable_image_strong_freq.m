function [] = cluster_parallel_data_gen_big_SNR_variable_image_strong_freq(signals_per_SNR, resize_method, transform, seed, train, sigma, image_size_row, image_size_col)
        ...
        for waveform_index = 1:length(waveforms)
            ...
            switch waveform
                case 'LFM'
                    ...
                    N = linspace(256,512,signals_per_SNR);
