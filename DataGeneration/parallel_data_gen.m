...
if shuffle
    ...
    parsave([prefix resize_method '_SST.h5'], input_train_SST, true);
    parsave([prefix resize_method '_noisy_SST.h5'], input_train_noisy_SST, true);
    parsave([prefix resize_method '_VSST.h5'], input_train_VSST, true);
    parsave([prefix resize_method '_noisy_VSST.h5'], input_train_noisy_VSST, true);
    ...
    parsave([output_prefix resize_method '.h5'], output_train_data, false);
end
%end
