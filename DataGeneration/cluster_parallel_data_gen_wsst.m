function [] = cluster_parallel_data_gen_wsst(signals_per_SNR, resize_method, transform, num_workers, seed, train, sigma)
    
    %pool = initParPool();
    
    output_dir = "./data";
    assert(exist(output_dir, "dir"), "The output directory does not exist");
    addpath(genpath("./synchrosqueezing-master/"))
    addpath("./Waveforms");
    addpath("./Transforms");
    addpath("./data");
    fs = 100e6;
            ...
            switch waveform
                case 'LFM'
                    ...
                    for idx = 1:signals_per_SNR
                        ...
                        resized_images = transform_data_wsst(wav, noisy_signal, 1024, image_size, real_noise_std, resize_method, transform, sigma);
