...
df6 = get_dataframe("logs_cluster/logs", "realcnn-attention-nearest-SST-0.05", "version_0")
df7 = get_dataframe("logs_cluster/logs","realcnn-attention-nearest-SST-0.06", "version_0")
df8 = get_dataframe("logs_cluster/logs","realcnn-attention-nearest-SST-0.07", "version_0")
...
df13 = get_dataframe("logs","real-cnn-nearest-sst", "version_0")
df_list = [df6, df7, df8, df9, df10, df11, df12, df13]
number_waveforms = 8
...
label_list = ["Sigma - 0.05", "Sigma - 0.06", "Sigma - 0.07", "Sigma - 0.08", "Sigma - 0.09", "Sigma - 0.1", "P1-P4-group", "No-group"]
